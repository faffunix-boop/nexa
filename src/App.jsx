    ...
    <div className="app-container">
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="sidebar-profile">
          ...
          <div className="profile-info">
            ...
            <span className="profile-plan">Pro Developer</span>
          </div>
        </div>
      ...
      <div className="workspace">
            ...
            {chat.length === 0 && !load ? (
              <div className="hero-section animate-fade">
                ...
                <div className="suggestion-prompts-container">
                  ...
                  <button
                    className="suggestion-btn"
                    onClick={() => handleSuggestionClick("Apakah itu Nexa AI dan apa yang boleh dibina?")}
                  >
                    Terangkan Nexa AI
                  </button>
                  <button
        ...
        {activeNav === "models" && (
          <div className="sub-panel-container animate-fade">
            <div className="sub-panel-inner">
              ...
              <p className="panel-subtitle">Available high performance intelligence units routing through Nexa AI.</p>
        ...
        {activeNav === "settings" && (
          <div className="sub-panel-container animate-fade">
            <div className="sub-panel-inner">
              <h2 className="panel-title">Settings & Preference</h2>
          ...
          <div className="sub-panel-container animate-fade">
            <div className="sub-panel-inner">
              ...
              <div className="ai-card">
                ...
                <p>Nexa utilizes state-of-the-art AI models to deliver extremely precise and fully modular answers tailored to development needs.</p>
